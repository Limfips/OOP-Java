...
#Переход по коммитам:
1. На нижнем тулбаре находим вкладку Version Control
2. Открываем и выбираем вкладку Log
3. Перед вами список всех коммитов
4. Нажмите на интересующий вас коммит правой кномкой мыши и выбираем вкладку Checkout Revision '<тег коммита>'
